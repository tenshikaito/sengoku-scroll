...
| 外交支出 | 赠金、和谈赔款等 | 事件触发 | `ForceActor.Money` | 和谈赔款 ✅；赠金 M5+ |
...
> **2026-09-05 实装说明**：粮食 + **马匹** 双品类大宗撮合；`CommodityDefinition` master 驱动 UI。做市 AI 已多档，并接入战争、敌军逼近、封锁、收粮窗口、价崩/上涨信号。跨城贸易只使用势力已经获得且不超过 60 日的行情，不再读取远端实时价格。诊断与全因素表见 [strategy-trade-market-design.md §14–§15](./strategy-trade-market-design.md)。
...
| 贸易 AI 情报时效（未知/超过 60 日不派单） | M4-d+ | ✅ 2026-09-05 |
| AI 月度经济政策（赈抚/平衡/增收） | M4-d+ | ✅ 2026-09-05 |
| AI 弱势求和、战争结束与 180 日停战 | M4-d+ | ✅ 2026-09-05 |
| V2 完整世界 + 外围运行台账存档 | M4-d+ | ✅ 2026-09-05 |
| 定额制/民心爆发 | M5+ | 待做 |
...
**尚未实装**：掠夺收入、建设投资、外交赠金、定额制歉年事件、店铺设施荒废与年度人口细则。和谈赔款与首版多条款和谈已实装。
...
> **首版实装（2026-09-05）**：野战胜利按败方损失累计 `+5～15`，占领据点按规模累计 `+10～30`，总分限制为 `-100～100` 并保存战果历史。议和经现有使节任务送达，支持白和平（维持当前疆界）、额外割让据点、赔款与外藩臣服；条款成本影响接受率，100 分可强制接受。主战国议和会结束整场战争、关闭关联 Battlefield，并为所有交战组合建立 180 日停战。朝贡比例、释放附庸与核心专属折扣仍属后续条款扩展。
