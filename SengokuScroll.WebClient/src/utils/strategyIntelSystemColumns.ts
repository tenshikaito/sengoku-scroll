...
const FORCE_ALL: IntelTableColumnDef[] = [
  { prop: "name", label: "势力", minWidth: 88 },
  ...
  { prop: "prestige", label: "威望", width: 56, align: "center" },
  { prop: "orthodoxy", label: "正统", width: 56, align: "center" },
];
...
const STRONGHOLD_ALL: IntelTableColumnDef[] = [
  { prop: "name", label: "据点", minWidth: 96 },
...
const PERSON_ALL: IntelTableColumnDef[] = [
  ...
  { prop: "leadership", label: "统率", width: 56, align: "center" },
  { prop: "power", label: "武勇", width: 56, align: "center" },
  { prop: "politics", label: "政治", width: 56, align: "center" },
  { prop: "strategy", label: "智谋", width: 56, align: "center" },
  { prop: "charm", label: "魅力", width: 56, align: "center" },
  { prop: "commandTarget", label: "命令对象", minWidth: 96 },
  { prop: "cultureName", label: "文化", width: 72 },
  { prop: "religionName", label: "信仰", width: 72 },
  { prop: "sex", label: "性别", width: 56 },
  ...PERSONALITY_DEV_COLUMNS,
  { prop: "skillInfantry", label: "步兵", width: 56, align: "center" },
  { prop: "skillRide", label: "骑马", width: 56, align: "center" },
  { prop: "skillArchery", label: "弓术", width: 56, align: "center" },
  { prop: "skillFirelock", label: "火枪", width: 56, align: "center" },
  { prop: "skillSealing", label: "航海", width: 56, align: "center" },
  { prop: "skillMilitary", label: "军略", width: 56, align: "center" },
  { prop: "skillFighting", label: "战斗", width: 56, align: "center" },
  { prop: "skillSpy", label: "谍报", width: 56, align: "center" },
  { prop: "skillAgriculture", label: "农业", width: 56, align: "center" },
  { prop: "skillCommerce", label: "商业", width: 56, align: "center" },
  { prop: "skillConstruct", label: "建筑", width: 56, align: "center" },
  { prop: "skillSmelt", label: "冶炼", width: 56, align: "center" },
  { prop: "skillEloquence", label: "辩才", width: 56, align: "center" },
  { prop: "skillCourt", label: "宫廷", width: 56, align: "center" },
  { prop: "skillSociality", label: "交际", width: 56, align: "center" },
  { prop: "skillHealing", label: "医术", width: 56, align: "center" },
];
...
export const PERSON_LIST_COLUMN_PRESETS: Record<PersonListPreset, IntelTableColumnDef[]> = {
  ...
  office: pickColumns(PERSON_ALL, ["name", "role", "yearsInForce", "age", "isFamily"]),
