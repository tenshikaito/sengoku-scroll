...
public static class EspionageIntelRules
{
        ...
        GameStartOptions? options = null)
    {
        ...
        return dto with
        {
            ...
            MilitiaSoldiers = hasMilitary ? dto.MilitiaSoldiers : 0,
            LaborCapacity = hasDomestic ? dto.LaborCapacity : 0,
            LaborAvailable = hasDomestic ? dto.LaborAvailable : 0,
            MilitiaAway = hasMilitary ? dto.MilitiaAway : 0,
            LaborRatioPercent = hasDomestic ? dto.LaborRatioPercent : 0,
            EffectiveCropPattern = hasDomestic ? dto.EffectiveCropPattern : AgricultureCropRules.Single,
            EarlyCropProgressPercent = hasDomestic ? dto.EarlyCropProgressPercent : 0,
            LateCropProgressPercent = hasDomestic ? dto.LateCropProgressPercent : 0,
            ThirdCropProgressPercent = hasDomestic ? dto.ThirdCropProgressPercent : 0,
            GarrisonTroopPools = hasMilitary ? dto.GarrisonTroopPools : [],
            StandingGarrisonUnits = hasMilitary ? dto.StandingGarrisonUnits : [],
            CropCycles = hasDomestic ? dto.CropCycles : [],
            AgricultureProductionPotential = hasDomestic ? dto.AgricultureProductionPotential : 0,
            KnowsDoubleCrop = hasDomestic && dto.KnowsDoubleCrop,
            KnowsTripleCrop = hasDomestic && dto.KnowsTripleCrop,
            CityActors = hasDomestic ? dto.CityActors : [],
